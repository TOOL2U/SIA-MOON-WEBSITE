...
export default function PropertyCard({ property }: PropertyCardProps) {
  return (
    <Link
      ...
      className="group block bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-1000"
    >
      ...
      <div className="p-5">
        ...
        <div className="mt-5 pt-4 border-t border-gray-200">
          <span className="inline-block bg-deep-green text-white px-4 py-2 rounded-md font-medium transition-colors duration-1000 hover:bg-terracotta">
            View Property
          </span>
        </div>
      </div>
