  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          <h3 className="text-xl mb-2">Berling Nova Sans W04 Regular</h3>
        ...
        <div>
          <h3 className="text-xl mb-2">Calluna (New Font)</h3>
          <p className="font-calluna text-lg">
            This text is using the Calluna font. The quick brown fox jumps over the lazy dog.
          </p>
        </div>
      </div>
    </div>
