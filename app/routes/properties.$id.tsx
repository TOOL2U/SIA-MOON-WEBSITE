    ...
    <div className="bg-deep-green pb-16">
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="text-center">
          <h1 className="text-6xl md:text-5xl font-arioso text-white mb-2">{property.name}</h1>
      ...
      <div className="w-full h-[1000px] bg-white px-4 mb-16">
        <div className="max-w-5xl w-[3000px] h-full mx-auto bg-white flex flex-col items-center justify-center">
          <div className="flex flex-wrap justify-center gap-8 mb-8 text-gray-700">
            <div className="flex items-center gap-2">
              <FaBed className="text-deep-green text-2xl" />
              <div>
          ...
          <h2 className="text-3xl font-arioso text-deep-green mb-4 text-center">About this property</h2>
          <p className="text-gray-700 mb-8 whitespace-pre-line leading-relaxed">
            {property.description}
          </p>

          <h3 className="text-2xl font-arioso text-deep-green mb-4 text-center">Amenities</h3>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-gray-700 max-w-3xl mx-auto">
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
          <h2 className="text-3xl font-arioso text-deep-green mb-6 text-center">Location</h2>
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
          <h2 className="text-3xl font-arioso text-deep-green mb-6 text-center">Policies</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="font-medium text-gray-800 mb-3 text-xl">Check-in & Check-out</h3>
            ...
            <div>
              <h3 className="font-medium text-gray-800 mb-3 text-xl">House Rules</h3>
              <ul className="space-y-2 text-gray-700">
                <li>No smoking</li>
                <li>No pets</li>
            ...
            <div>
              <h3 className="font-medium text-gray-800 mb-3 text-xl">Cancellation Policy</h3>
            ...
            <div>
              <h3 className="font-medium text-gray-800 mb-3 text-xl">Additional Notes</h3>
              <p className="text-gray-700 leading-relaxed">
